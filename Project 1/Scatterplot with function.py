...
diff ("Subject_identifier")

# for x in range(22,40):
#     working = withoutpark[withoutpark["Subject_identifier"]==x]
#     updrs = working.UPDRS.values
#     updrs1 = st.tmean(updrs)
#     nyplot.append(int(updrs1))
#     def cycle(a):
#         working1 = a
#         x_bar = st.tmean(working1)
#         nxplot.append(float(x_bar))
